...
// 5- Create a string variable called "message" and assign it a message of your choice.
 /******* Start Your Code *********/
  ...
  let message = "My Name Is Majd Alkaseeh";
//   let length = message.length;
  console.log(message); 
//   document.getElementById("demo").innerHTML =  isStudent;
...
// 6- Use template literals to create a string that includes the variables "name" and "age".
 ...
 let nameeee = "majd";
 let age = 23;
 let intro =`my name is  ${nameee} and Iam  ${age}`;
 console.log(intro);
...
// 10- Use the string method "indexOf()" to find the position of the word "JavaScript" in the string "I love learning JavaScript".
 /******* Start Your Code *********/
  let jav ='I love learning JavaScript';
  let index= jav.indexOf("JavaScript");
  console.log(index);
